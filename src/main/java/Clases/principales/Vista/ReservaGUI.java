   ...
   public ReservaGUI() {
    ...
    private void buscarReservas() {
        try {
            ...
            for (Object[] reserva : reservaDAO.getReservasConNombres(filtroColumna, valor)) {
    ...
    if (filaSeleccionada >= 0) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                ...
                reservaDAO.actualizarEstadoReserva(idReserva, "cancelada");
