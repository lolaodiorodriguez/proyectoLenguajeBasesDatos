...
ReservaGUI reservas=new ReservaGUI();
...
HabitacionesGUI habitacion=new HabitacionesGUI();
habitacion.setVisible(true);// TODO add your handling code here:
