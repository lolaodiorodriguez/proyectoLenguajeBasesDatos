...
EXEC agregarCliente(2, 'Ejemplo','Mora','Mora','Ej@gmail.com','22493041','Calle Leo, frente a Escuela G');
...
EXEC actualizarClienteExistente(1, 'Pedro','Robles','LÃ³pez','PedroRL@gmail.com','22493030','Calle LÃ³pez frente a Escuela HernÃ¡ndez');
...
EXEC agregarEmpleado(4, 'Ejemplo','Torres PÃ©rez', TO_DATE('2024-11-16', 'YYYY-MM-DD'));
...
EXEC actualizarEmpleadoExistente(2,'Alexis','Torres CalderÃ³n', TO_DATE('2024-11-14', 'YYYY-MM-DD'));
...
BEGIN
    AgregarHotel(1, 'Hotel Barcelo', 'Jaco',  '89898989');
END;
...
BEGIN
    ActualizarHotel(1, 'Hotel Rio', 'Guanacaste', '70707070');
END;
...
BEGIN
    AgregarProveedor(1, 'Limpieza Eficaz', '67676767', 'San Jose', 'liempieza@gmail.com',1);
END;
...
BEGIN
    ActualizarProveedor(1, 'Limpieza Eficaz 2', '80808080', 'SAN JOSE', 'liempieza@gmail.com', 1);
END;
...
BEGIN 
    AgregarSuministro(1, 'Cloro ', 'Cloro 95%', 100, 750, 1,1);
END;
...
BEGIN 
    ActualizarSuministro(1, 'Cloro ', 'Cloro 99%', 100, 750, 1,1);
END;
...
BEGIN 
    AgregarHabitacion(1, 'Sencilla', 25000,1,1);
END;
...
BEGIN
    ActualizarHabitacion(1, 'Doble', 50000, 2,0);
END;
...
BEGIN
    AgregarReserva( 2,1, 1, TO_DATE('2024-12-20', 'YYYY-MM-DD'),TO_DATE('2024-12-25', 'YYYY-MM-DD'), 'Confirmada',1);
END;
